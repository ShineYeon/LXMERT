...
class VQA:
    ...
    def train(self, train_tuple, eval_tuple):
        ...
        for epoch in range(args.epochs):
            ...
            log_str = "\nEpoch %d: Train %0.2f\n" % (epoch, evaluator.evaluate(quesid2ans))
    ...
    def predict(self, eval_tuple: DataTuple, dump=None):
        """
        data split으로 question에 대한 answer를 예측
...
if __name__ == "__main__":
    ...
    if args.test is not None:
        ...
        if 'test' in args.test:
            ...
            # validation data의 일부는 pre-training 혹은 fine-tuning에 사용되기 때문에, validation은 minival set에 대해서만 실행
            result = vqa.evaluate(
